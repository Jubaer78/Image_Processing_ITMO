...
### Convergence Анализ:
Сходимость измерялась как **количество эпох**, прошедших до достижения моделью плато производительности, определяемого как отсутствие значительного улучшения в потере данных при валидации для последовательных эпох.

**Критерии сходимости:**
- Ранняя остановка с терпением = 2 epochs
- Минимальный порог улучшения = 0,001
- Обучение останавливается, когда потеря данных при валидации не улучшается в течение 2 последовательных эпох

**Ключевые выводы:**
- Модели SSL сходятся **в 2-3 раза быстрее**, чем базовые модели
- SSL больше выигрывает от дополнительных данных с точки зрения скорости сходимости
- Базовым моделям требуется больше эпох для достижения оптимальной производительности
